 ...
 * @since       1.3
 */
public class ProxyGeneratorOriginal {
    /*
...
//  private static final int opc_jsr_w                  = 201;
    ...
    public static byte[] generateProxyClass(final String name,
                                            Class[] interfaces)
    {
        ProxyGeneratorOriginal gen = new ProxyGeneratorOriginal(name, interfaces);
     ...
     */
    private ProxyGeneratorOriginal(String className, Class[] interfaces) {
