...
public class PasswordUtil {
	...
	public static final String PASSWORD = "123456";//password生成密钥时所使用的密码
	 ...
	 * @return
	 */
	public static String genricsPassword(int length){
		String code =String.valueOf((int) (Math.random() * 1000000));// 0-10000以内的随机数，用Matn.random()方式
		for (int i = 1; i > 0 ; i++) {
