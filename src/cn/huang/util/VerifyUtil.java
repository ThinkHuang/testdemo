...
public class VerifyUtil {
	...
	public static Map<String, String> getImg(final HttpServletRequest request, final HttpServletResponse response)
		...
		// 取随机产生的认证码(4位数字)
		final String resultCode = exctractRandCode(RandCodeImageEnum.ALL_CHAR.getCharStr(), 10);
		...
		map.put("verifyCode", resultCode);// 验证码
		map.put("rnd", rnd);
		return map;
	}
	 ...
	 * @return 随机码
	 */
	private static String exctractRandCode(String randCodeType, int randCodeLength) {
